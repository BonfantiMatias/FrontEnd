!(function (t, e) {
  ...
  function it(t) {
    Je.isVisible() && ct !== t.target.value && Je.resetValidationMessage(),
      (ct = t.target.value);
  }
  function rt(t, e) {
  ...
  function St(t, i) {
    ...
    X(r), (r.innerHTML = "");
    var a = parseInt(
      void 0 === i.currentProgressStep ? Et() : i.currentProgressStep
    );
  ...
  var Mt = function () {
    ...
    qt = function (t, e) {
      (t.className = ""
        ...
        e.icon && st(t, z["icon-".concat(e.icon)]);
    };
  function Rt() {
    var t = C();
    t || Je.fire(), (t = C());
  ...
  function Nt() {
    return new Promise(function (t) {
      ...
      (zt.restoreFocusTimeout = setTimeout(function () {
        zt.previousActiveElement && zt.previousActiveElement.focus
  ...
  function $t() {
    ...
    if (t) {
      ...
      t.showConfirmButton ||
        ...
        ut([e.popup, e.actions], z.loading),
  ...
  var re = function (t, e, n, o) {
      (zt.swalCloseEventFinishedCallback = ne.bind(null, t, n, K(), o)),
  ...
  function fe(t) {
    ...
    "function" == typeof t.onBeforeOpen && t.onBeforeOpen(n),
      xe(e, n, t),
      Ce(e, n),
      I() && ke(e, t.scrollbarPadding),
      K() ||
        zt.previousActiveElement ||
        (zt.previousActiveElement = document.activeElement),
  ...
  var Ce = function (e, n) {
      ht && et(n)
        ? ((e.style.overflowY = "hidden"),
          n.addEventListener(ht, function (t) {
    ...
    ke = function (t, e) {
      !(function () {
        ...
        "undefined" != typeof window &&
          Xt() &&
          (Gt(), window.addEventListener("resize", Gt)),
        m(document.body.children).forEach(function (t) {
          t === y() ||
            (function (t, e) {
        ...
        ? (e.disableInput(),
          Promise.resolve()
            ...
            .then(function (t) {
              e.enableButtons(),
                e.enableInput(),
                t ? e.showValidationMessage(t) : Me(e, n, o);
            }))
    ...
    Me = function (e, t, n) {
      (t.showLoaderOnConfirm && Rt(), t.preConfirm)
      ...
      e.container.onmousedown = function () {
        e.popup.onmouseup = function (t) {
          (e.popup.onmouseup = void 0),
            (t.target !== e.popup && !e.popup.contains(t.target)) || (Ue = !0);
        };
      };
    },
    ze = function (e, n, o) {
  ...
  var Ze,
    Qe = Object.freeze({
      ...
      _main: function (t) {
        !(function (t) {
          for (var e in t)
            Ft((i = e)) || D('Unknown parameter "'.concat(i, '"')),
              t.toast &&
                ((o = e),
                -1 !== Zt.indexOf(o) &&
                  D(
          ...
          zt.deferDisposalTimer &&
            (clearTimeout(zt.deferDisposalTimer), delete zt.deferDisposalTimer);
        var e = (function (t) {
        ...
        de(e),
          Object.freeze(e),
          zt.timeout && (zt.timeout.stop(), delete zt.timeout),
